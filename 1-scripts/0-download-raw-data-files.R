...
# Raw data for script 1.1: Download DHS files from Google Drive to local files ----
...
# Raw data for script 2.1: Download India shape files from Google Drive to local files ----
## List all files in the Google Drive folder
...
for (y in year){
  download.file(paste("https://data.chc.ucsb.edu/products/CHIRPS-2.0/global_daily/netcdf/p05/chirps-v2.0."
                ,y,".days_p05.nc",sep=""),
