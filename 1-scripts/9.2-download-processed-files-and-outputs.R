...
# Get ID of the folders to download from
## Main Outputs
...
!dir.exists(path_dest_supp_fig) && dir.create(path_dest_supp_fig, recursive = TRUE)
path_dest_supp_model_no_int <- here("3-outputs", "supplements", "models", "models-no-interaction")
!dir.exists(path_dest_supp_model_no_int) && dir.create(path_dest_supp_model_no_int, recursive = TRUE)
path_dest_supp_model_int <- here("3-outputs", "supplements", "models", "models-with-interaction")
!dir.exists(path_dest_supp_model_int) && dir.create(path_dest_supp_model_int, recursive = TRUE)
