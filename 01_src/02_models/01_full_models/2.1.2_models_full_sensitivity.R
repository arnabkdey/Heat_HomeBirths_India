...
source(here("01_src", "02_models", "utils", "function_full_model_gee.R"))
source(here("01_src", "02_models", "utils", "function_full_model_glmer.R"))
...
run_full_analysis(
  ...
  corstr = "ar1",
  model_type = "gee",
  output_dir = here(path_project, "outputs", "models", "full_models", "sensitivity_models", "own_home")
) 
...
run_full_analysis(
  ...
  corstr = "ar1",
  model_type = "gee",
  output_dir = here(path_project, "outputs", "models", "full_models", "sensitivity_models", "one_child")
)
...
run_full_analysis(
  ...
  corstr = "exchangeable",
  model_type = "gee",
  output_dir = here(path_project, "outputs", "models", "full_models", "sensitivity_models", "exchangeable")
)
...
run_full_analysis(
  ...
  corstr = "ar1",
  model_type = "gee",
  output_dir = here(path_project, "outputs", "models", "full_models", "sensitivity_models", "relaxed_trimming_95")
)
...
run_full_analysis(
  ...
  covariates = covariates_all,
  dv_var = "dv_home_del_num",
  cluster_var = "state_name_fac",
  model_type = "glmer",
  output_dir = here(path_project, "outputs", "models", "full_models", "sensitivity_models", "glmer_state")
)
