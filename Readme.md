...
## [1-scripts/2.2-models-run-all-interactions](1-scripts/2.2-models-run-all-interactions.R)
...
## [1-scripts/3.2-output-extract-coefs-no-interaction](1-scripts/3.2-output-extract-coefs-no-interaction.R)
...
## [1-scripts/3.3-models-extract-coefs-all-interactions](1-scripts/3.3-models-extract-coefs-all-interactions.R)
